    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var instructor = await _context.Instructors
                .Include(i => i.OfficeAssignment) //Week 6
                .Include(i => i.Courses).ThenInclude(i => i.Course) //Week 6
                .AsNoTracking() //Week 6
            ...
            PopulateAssignedCourseData(instructor); //Week 6
            return View(instructor);
        }
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            foreach (var course in _context.Courses)
            {
                ...
                else
                {
                    if (instructorCourses.Contains(course.CourseID))
                    {
                        CourseAssignment courseToRemove = instructorToUpdate.Courses.SingleOrDefault(i => i.CourseID
                        == course.CourseID);

...
namespace ContosoUniversity.Controllers
{
	public class StudentsController : Controller
    {
		...
		public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
			...
			// if there is no searchString it means the filter setting didn't changed.
		...
		public async Task<IActionResult> Delete(int? id, bool? saveChangesError = false)
		{
			...
			var student = await _context.Students.AsNoTracking().SingleOrDefaultAsync(m => m.ID == id); if (student == null)
			{
		...
		public async Task<IActionResult> DeleteConfirmed(int id)
		{
			...
			try
			{
				...
				_context.Students.Remove(student); await _context.SaveChangesAsync(); return RedirectToAction("Index");
